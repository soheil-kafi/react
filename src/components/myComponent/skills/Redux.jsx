...
export const Redux = () => {
  return (
    <div className="w-33 card">
      <NavLink to="redux">
        <div className="p-2">
          <div className="light-color">
            <div className="d-flex justify-content-center align-content-center text-color">
              redux
            </div>
            ...
            <div className="text-center">
              <span>redux</span>
              is a package we call "state management" thats help to keep states
              in "store" and we access to them anyWhere anyTime
            </div>
          </div>
        </div>
      </NavLink>
